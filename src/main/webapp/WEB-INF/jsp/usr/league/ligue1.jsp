...
<%@ include file="../common/header.jsp" %>
	...
	<script>
		...
		$.ajax(settings).done(function(response) {
			...
			for ( var i = 0; i <= 305; i++ ) {
				...
				if (response.response[matchNumInt].fixture.status.short == "1H" && "2H") {
					$(".OnAirmatch" + matchNumStr + "Date").append((response.response[matchNumInt].fixture.date).substring(0, 10));
				  	$(".OnAirmatch" + matchNumStr + "Time").append((response.response[matchNumInt].fixture.date).substring(11, 16));
				  	$(".OnAirmatch" + matchNumStr + "Status").append(response.response[matchNumInt].fixture.status.short);
					$(".OnAirmatch" + matchNumStr + "HomeLogo").append('<img src="' + response.response[matchNumInt].teams.home.logo + '"/>');
					$(".OnAirmatch" + matchNumStr + "AwayLogo").append('<img src="' + response.response[matchNumInt].teams.away.logo + '"/>');
					$(".OnAirmatch" + matchNumStr + "HomeScore").append(response.response[matchNumInt].goals.home);
					$(".OnAirmatch" + matchNumStr + "AwayScore").append(response.response[matchNumInt].goals.away);
				}
			}
		...
		const settings2 = {
				async: true,
				crossDomain: true,
				url: 'https://api-football-v1.p.rapidapi.com/v3/standings?league=61&season=2024',
				method: 'GET',
				headers: {
					'x-rapidapi-key': '3a012c58fdmsh42f7e05c92b7f66p1ed97ejsn1660d3e9d81f',
					'x-rapidapi-host': 'api-football-v1.p.rapidapi.com'
	...
	<section class="flex">
		...
		<div class="container mx-auto">
			<div class="mt-2 flex justify-center">
				<div class="ligue1Logo w-24"></div>
			</div>
			
			<div class="mt-2 flex justify-center">
				<div class="ligue1Flag w-6 border-2 border-inherit"></div>
			</div>
